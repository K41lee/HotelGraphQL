package org.examples.serverrivage.grpc;
...
/**
 * Implémentation gRPC du HotelService pour server-rivage
...
public class HotelGrpcServiceImpl extends HotelServiceGrpc.HotelServiceImplBase {
    ...
    public void getCatalog(CatalogRequest request, StreamObserver<HotelCatalog> responseObserver) {
        try {
            ...
            catalogDto.setAgencies(java.util.Arrays.asList("rivageAgency"));
    ...
    public void makeReservation(ReservationRequest request, StreamObserver<Reservation> responseObserver) {
        try {
            ...
            logger.info("[HOTEL:rivage] ⭐ Requête gRPC reçue - agencyName='{}'", request.getAgencyName());
            ...
            logger.info("[HOTEL:rivage] ⭐ Agence enregistrée en BDD: '{}'", agencyName);
